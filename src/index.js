...
app.delete(_ACCOUNT_, (request, response) => {  // Delete account.
   const {customer} = request;
...
app.post(_CREDIT_, (request, response) => {     // Create credit statement.
   const {customer} = request;
...
app.post(_DEBIT_, (request, response) => {      // Create debit statement.
   const {customer} = request;
   const transaction = request.body;
